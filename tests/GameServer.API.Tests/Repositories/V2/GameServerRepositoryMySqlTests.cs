...
public class GameServerRepositoryMySqlTests : IAsyncLifetime
{
    ...
    public async ValueTask InitializeAsync()
    {
        ...
        var gameType = await _gameTypeRepository.CreateAsync(new GameServer.API.Models.V2.GameType
        {
            ...
            Revisions =
            [
                new GameServer.API.Models.V2.GameTypeRevision
                {
                    ...
                    Ports =
                    [
                        new GameServer.API.Models.V2.GameTypePort { ContainerPort = 25565, Protocol = "tcp", AdvertisedPort = true }
                    ]
                }
            ]
        });
