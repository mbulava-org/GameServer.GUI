...
using Moq;
using V2Repositories = GameServer.API.Repositories.V2;
...
public class DatabaseInitializationServiceTests
{
    ...
    private sealed class TestDatabaseInitializationService(
        ...
        : DatabaseInitializationService(serviceProvider, applicationLifetime, new GameServer.API.Services.DatabaseReadinessGate(), logger)
    {
