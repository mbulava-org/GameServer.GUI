...
See **[docs/QUICK-START.md](docs/QUICK-START.md)** for local development and Docker Swarm deployment instructions. Default login: `admin` / `Admin123!`.
...
| `/admin/users` | Admin user management, roles, and group memberships |
| `/admin/groups` | Admin group management and server access boundaries |
...
- **V2**: `/api/v2/gametypes`, `/api/v2/gameservers`, `/api/v2/auth`, `/api/v2/users`, `/api/v2/groups`
