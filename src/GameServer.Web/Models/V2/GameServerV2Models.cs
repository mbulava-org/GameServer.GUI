...
public sealed record ContainerImageUpdateStatus
{
    public string ServerId { get; init; } = string.Empty;
...
public sealed record GameServerDetail
{
    ...
    public ContainerImageUpdateStatus? ImageUpdateStatus { get; init; }
...
public sealed record GameServerCalculatedResourceHistory
{
    public string ServerId { get; init; } = string.Empty;
    ...
    public IReadOnlyList<GameServerCalculatedResourceHistoryPoint> Points { get; init; } = [];
}

public sealed record GameServerCalculatedResourceHistoryPoint
{
    public DateTime Timestamp { get; init; }
