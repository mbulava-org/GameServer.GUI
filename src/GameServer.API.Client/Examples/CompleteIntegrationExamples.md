# GameServer.API.Client - Complete Integration Examples

## Overview

This document provides comprehensive examples for integrating the GameServer.API.Client library into your application, covering both REST API clients and SignalR real-time features.
...
public class GameServersController : ControllerBase
{
    ...
    {
        var httpClient = httpClientFactory.CreateClient("GameServer.API.Api");
...
public class ServerMonitoringService : BackgroundService
{
    ...
    {
        var httpClient = _httpClientFactory.CreateClient("GameServer.API.Api");
...
// Register GameServer.API clients
builder.Services.AddGameServerClients(
