...
public sealed record GameTypeRevision
{
    ...
    /// <summary>
    /// JSON-serialized list of <c>GameTypeUiExtensionDescriptor</c> declaring which
    ...
    /// <summary>
    /// JSON-serialized <c>GameTypeRevisionResources</c> declaring CPU, memory reservations/limits,
    ...
    /// <summary>
    /// JSON-serialized <c>GameTypeRevisionHealthcheck</c> declaring start_period, interval, timeout,
